...
CREATE TABLE `user_selections` (
  ...
  `userID` int NOT NULL,
  `message_type` enum('chatroom','test_results') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `message_usertostaff` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `contentback` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `updatedAt` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`selectionID`),
  KEY `userID` (`userID`),
  CONSTRAINT `user_selections_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `users` (`userID`) ON DELETE CASCADE
